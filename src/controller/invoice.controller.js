...
export async function create(req, res) {
    try {
        ...
        if (!invoice) return res.status(400).json({ message: 'Invoice not created' })
...
export async function update(req, res) {
    try {
        ...
        if (!invoice) return res.status(400).json({ message: 'Invoice not updated' })
...
export async function removeById(req, res) {
    try {
        ...
        if (!invoice) return res.status(400).json({ message: 'Invoice not deleted' })
        return res.status(204).json({
